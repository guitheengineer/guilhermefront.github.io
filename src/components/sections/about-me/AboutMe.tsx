  ...
  <div className="About-me">
    <div className="About-me__text-container">
      ...
      <p className="About-me__myself">
        ...
        solved in those games are also present in the programming area, which is
        where I found myself able to build useful tools for people. So, since I
        entered college at seventeen, I decided to dedicate all my efforts in
        this area. Currently I’m working intensively with React. In my free time
        I love studying UX/UI concepts to reach a better looking and user
        experience of my personal projects and to give suggestions to my
        clients.
      </p>
      <Heading
    ...
    <img className="About-me__img" alt="gameboy illustration" src={gameboy} />
  </div>
);
